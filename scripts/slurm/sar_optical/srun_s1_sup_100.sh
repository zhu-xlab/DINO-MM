...
#SBATCH --output=srun_outputs/B2_sup_vit_s_8_100_%j.out
#SBATCH --error=srun_outputs/B2_sup_vit_s_8_100_%j.err
...
--output_dir /p/project/hai_dm4eo/wang_yi/ssl4eo-s1s2/src/checkpoints/sup/B2_vit_s_8_100_new \
--lmdb \
--train_frac 1 \
--arch vit_small \
--workers 8 \
