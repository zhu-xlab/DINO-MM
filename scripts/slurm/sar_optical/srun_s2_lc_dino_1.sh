...
#SBATCH --output=srun_outputs/B12_lc_vit_s_8_1_%j.out
#SBATCH --error=srun_outputs/B12_lc_vit_s_8_1_%j.err
#SBATCH --time=05:00:00
#SBATCH --job-name=s2_lc
#SBATCH --gres=gpu:4
...
--output_dir /p/project/hai_dm4eo/wang_yi/ssl4eo-s1s2/src/checkpoints/dino_lc/B12_vit_s_8_1 \
--lmdb \
--train_frac 0.01 \
--arch vit_small \
--patch_size 8 \
